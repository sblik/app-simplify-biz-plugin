...
{
    private AttendeeDashboardRepository $exampleRepository;

    public function __construct(AttendeeDashboardRepository $exampleRepository)
    {
    ...
    {
        $exampleEntry = new AttendeeDashboardEntity($entry);                 //If the form submitted is the same as the entity
